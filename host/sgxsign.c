...
static oe_result_t _get_modulus(
	const oe_rsa_public_key_t* rsa, uint8_t modulus[OE_KEY_SIZE])
{
    oe_result_t result = OE_UNEXPECTED;
...
static oe_result_t _get_exponent(
	const oe_rsa_public_key_t* rsa, uint8_t exponent[OE_EXPONENT_SIZE])
{
    oe_result_t result = OE_UNEXPECTED;
	...
	mbedtls_mpi* q2)
{
     ...
     */
    {
        ...
        /*
         * As shown by the derivations of Q1 and Q1, we can get Q2 by
